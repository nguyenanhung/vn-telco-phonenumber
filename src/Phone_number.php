 ...
 */
class Phone_number extends BaseCore implements PhoneNumberInterface
{
    ...
    {
        return $this->is_valid($phone_number, $region);
    }
    ...
    {
        return $this->is_possible_number($phone_number, $region);
    }
    ...
    {
        return $this->get_time_zones_for_number($phone_number, $region);
    }
    ...
    {
        return $this->get_carrier_name_for_number($phone_number, $region, $mode);
    }
    ...
    {
        return $this->get_geocode_description_for_number($phone_number, $region, $mode);
    }
    ...
    {
        return $this->get_region_code_for_number($phone_number, $region);
    }
    ...
    {
        return $this->get_country_code_for_region($region);
    }
    ...
    {
        return $this->get_region_codes_for_country_code($region_codes);
    }
    ...
    {
        return $this->get_number_type($phone_number, $region);
    }
    ...
    {
        return $this->check_phone_number_can_be_internationally_dialled($phone_number, $region);
    }
    ...
    {
        return $this->find_phone_number_in_string($text, $region);
    }
    ...
    {
        return $this->get_national_number($phone_number);
    }
    ...
    {
        return $this->format_hidden($phone_number, $place_hidden);
    }
    ...
    {
        return $this->detect_carrier($phone_number, $get_field_data);
    }
    ...
    {
        return $this->vn_convert_phone_number($phone_number, $phone_mode, $phone_format);
    }
    ...
    {
        return $this->vn_phone_number_old_and_new($phone_number, $phone_format);
    }
}
